...
import sys
import textwrap
from typing import Dict, List, Mapping, MutableMapping, Sequence, Text, Union
...
def _dump_ui_metadata(node: pipeline_pb2.PipelineNode,
  ...
  def _dump_input_populated_artifacts(
      node_inputs: Dict[Text, pipeline_pb2.InputSpec],
  ...
  def _dump_output_populated_artifacts(
      node_outputs: Dict[Text, pipeline_pb2.OutputSpec],
      name_to_artifacts: Dict[Text, List[artifact.Artifact]]) -> List[Text]:
